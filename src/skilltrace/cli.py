...
def build_parser() -> argparse.ArgumentParser:
    ...
    # it is READ_ONLY and appends no audit event. Co-located in
    # commands/impact.py when migrated (guarded like health/sync above).
    if "graph impact" not in colocated:
