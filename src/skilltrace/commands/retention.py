...
def add_parser(subparsers: argparse._SubParsersAction) -> None:
    """Attach the `retention` parser (issue #206, expand–contract).

    Co-located owner of the `retention` argparse surface; `cli.build_parser`
    calls this for the new path and skips its legacy `retention` block.
    """
