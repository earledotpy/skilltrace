...
def add_parser(subparsers: argparse._SubParsersAction) -> None:
    """Attach the `pass` parser to the top-level `subparsers` (issue #207 contract).

    Co-located owner of the `pass` argparse surface (issue #207 contract: sole source of CLI flags and help text).
    """
